(() => {
  ...
  const d = document.querySelector(".hero"),
    h = document.getElementById("parallax-item1"),
    u = document.getElementById("parallax-item2"),
    m = document.getElementById("parallax-item3");
  (window.onscroll = () => {
    window.scrollY <= d.offsetHeight &&
      (function () {
        ...
        let o = t / e;
        o > 100 && (o = 100),
          (h.style.transform = `translateY(${(o * e) / 1.8}px)`),
          (u.style.transform = `translateY(${(o * e) / 2.4}px)`),
          (m.style.transform = `translateY(${(o * e) / 3}px)`);
      })();
  }),
